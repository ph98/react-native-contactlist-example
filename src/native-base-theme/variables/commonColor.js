...
export default {
  ...
  // Button
  btnFontFamily: platform === "ios" ? "IRANSansMobile(FaNum)" : "IRANSansMobile(FaNum)_Bold",
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === "ios" ? "IRANSansMobile(FaNum)" : "IRANSansMobile(FaNum)",
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === "ios" ? "#fcc432" : "#fcc432",
  ...
  topTabBarTextColor: Colors.dark,
  topTabBarActiveTextColor: platform === "ios" ? "#007aff" : "#fff",
  topTabBarBorderColor: Colors.primary,
  ...
  // Title
  titleFontfamily: platform === "ios" ? "IRANSansMobile(FaNum)" : "IRANSansMobile(FaNum)_Bold",
